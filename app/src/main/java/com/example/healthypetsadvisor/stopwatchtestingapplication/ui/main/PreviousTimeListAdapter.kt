...
class PreviousTimeListAdapter :
    ListAdapter<PreviousTimeElement, PreviousTimeListAdapter.PreviousTimeElementListViewHolder>(PreviousTimeDiffUtil()) {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PreviousTimeElementListViewHolder {
    ...
    class PreviousTimeElementListViewHolder(private val context: Context, private val binding: PreviousTimeListElementBinding) :
